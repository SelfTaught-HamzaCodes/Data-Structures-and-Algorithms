class HashTable:
    ...
    def __getitem__(self, key):
        ...
        self.__quadratic_probing(hash_value, key, state="get")
    ...
    def __setitem__(self, key, value):
        ...
        self.__quadratic_probing(hash_value, key, value, state="set")
    ...
    def __delitem__(self, key):
        ...
        self.__quadratic_probing(hash_value, key, state="del")

    def __folding_method(self, key, num_parts):
    ...
    def __quadratic_probing(self, hash_value, key, value=None, state=None):
    ...
    def __get_hash_value(self, key):
        ...
        hash_value = self.__folding_method(key, 2)
